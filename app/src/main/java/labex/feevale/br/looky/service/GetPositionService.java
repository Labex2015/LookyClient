...
public class GetPositionService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, FIVE_MINUTES, FIFTY_METERS, listener);
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, FIVE_MINUTES, FIFTY_METERS, listener);
